 ...
 */
export class MySpaceCubeMap extends CGFobject {
	constructor(scene) {
		super(scene);
		this.scene = scene;
		this.init();
	...
	updateAppliedTexture() {
        ...
        this.texture = new CGFtexture(this.scene, "scenes/images/textures/space.jpeg");
        this.texture2 = new CGFtexture(this.scene, "scenes/images/textures/blackhole.jpg");
	...
	display() {
		...
		this.scene.pushMatrix();
        this.scene.setActiveShader(this.scene.spaceShader);
