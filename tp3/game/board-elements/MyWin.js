...
export class MyWin extends CGFobject {
  ...
  display(){
    ...
    this.displayLetter(0,5,this.p_letter, 0,5,0, 1, 1, 1);
    this.displayLetter(12,4,this.l_letter, 0.5,5,0, 1, 1, 1);
    this.displayLetter(1,4,this.a_letter, 1,5,0, 1, 1, 1);
    this.displayLetter(9,5,this.y_letter, 1.5,5,0, 1, 1, 1);
    this.displayLetter(5,4,this.e_letter, 2,5,0, 1, 1, 1);
    this.displayLetter(2,5,this.r_letter, 2.5,5,0, 1, 1, 1);
    this.displayLetter(this.n,3,this.number, 3.3,5,0, 1, 1, 1);
    this.displayLetter(7,5,this.w_letter, 3.8,5,0, 1, 1, 1);
    this.displayLetter(9,4,this.i_letter, 4.5,5,0, 1, 1, 1);
    this.displayLetter(14,4,this.n_letter, 4.8,5,0, 1, 1, 1);
