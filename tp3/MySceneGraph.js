...
export class MySceneGraph {
  ...
  constructor(filename, scene) {
    ...
    this.displayPlayer1 = true;
    this.displayPlayer2 = true;
  }
  ...
  parseView(viewsNode) {
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      if (viewId == null) return "no ID defined for camera";
      ...
      if (!(near != null && !isNaN(near)))
        this.onXMLMinorError(
          "unable to parse value component of the 'near' field for ID = " +
            viewId
        );

      if (!(far != null && !isNaN(far)))
        this.onXMLMinorError(
          "unable to parse value component of the 'far' field for ID = " +
            viewId
        );
      ...
      if (children[i].nodeName == "ortho") {
        ...
        if (!(left != null && !isNaN(left)))
          return (
            "unable to parse left component of the view for ID = " + viewId
          );

        var right = this.reader.getFloat(children[i], "right");
        if (!(right != null && !isNaN(right)))
          return (
            "unable to parse right component of the view for ID = " + viewId
          );
        ...
        if (!(bottom != null && !isNaN(bottom)))
          return (
            "unable to parse bottom component of the view for ID = " + viewId
          );
        ...
        if (upIndex != -1) {
          var aux = this.parseCoordinates3D(
            ...
            "up values for ID " + viewId
          );
          if (!Array.isArray(aux)) return aux;

          upView = aux;
        } else upView = this.axisCoords["y"];
    ...
    if (
      this.views[this.defaultCameraID] == null &&
      this.defaultCameraID != null
    )
      this.onXMLError(
        "Error: Declared a default camera ID " +
          defaultCameraID +
  ...
  parseLights(lightsNode) {
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      if (attenuationIndex != -1) {
        var constant = this.reader.getFloat(
          grandChildren[attenuationIndex],
          "constant"
        );
        var quadratic = this.reader.getFloat(
          grandChildren[attenuationIndex],
          "quadratic"
        );
        var linear = this.reader.getFloat(
          grandChildren[attenuationIndex],
          "linear"
        );
  ...
  parseTextures(texturesNode) {
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      if (tex.id == null) return "no ID defined for texture";

      // Checks for repeated IDs
      if (this.textures[tex.id] != null) {
        return (
          "ID must be unique for each texture (conflict: ID = " + tex.id + ")"
        );
      }
  ...
  parseMaterials(materialsNode) {
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      var emission = this.parseColor(
        grandChildren[0],
        "emission propertie of the material with ID = " + materialID
      );
      var ambient = this.parseColor(
        grandChildren[1],
        "ambient propertie of the material with ID = " + materialID
      );
      var diffuse = this.parseColor(
        grandChildren[2],
        "diffuse propertie of the material with ID = " + materialID
      );
      var specular = this.parseColor(
        grandChildren[3],
        "specular propertie of the material with ID = " + materialID
      );
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      if (primitiveType == "rectangle") {
        ...
        if (!(base != null && !isNaN(base)))
          return (
            "unable to parse base of the primitive attributes for ID = " +
            primitiveId
          );
        ...
        if (!(top != null && !isNaN(top)))
          return (
            "unable to parse top of the primitive attributes for ID = " +
            primitiveId
          );
        ...
        if (!(height != null && !isNaN(height)))
          return (
            "unable to parse height of the primitive attributes for ID = " +
            primitiveId
          );
        ...
        if (!(slices != null && !isNaN(slices)))
          return (
            "unable to parse slices of the primitive attributes for ID = " +
            primitiveId
          );
        ...
        if (!(stacks != null && !isNaN(stacks)))
          return (
            "unable to parse stacks of the primitive attributes for ID = " +
            primitiveId
          );

        var cylin = new MyCylinder(
          this.scene,
          primitiveId,
          height,
          top,
        ...
        if (!(radius != null && !isNaN(radius)))
          return (
            "unable to parse radius of the primitive attributes for ID = " +
            primitiveId
          );
        ...
        if (!(inner != null && !isNaN(inner)))
          return (
            "unable to parse inner of the primitive attributes for ID = " +
            primitiveId
          );
        ...
        if (!(outer != null && !isNaN(outer)))
          return (
            "unable to parse outer of the primitive attributes for ID = " +
            primitiveId
          );
        ...
        if (!(loops != null && !isNaN(loops)))
          return (
            "unable to parse loops of the primitive attributes for ID = " +
            primitiveId
          );
        ...
        if (!(degree_u != null && !isNaN(degree_u)))
          return (
            "unable to parse degree_u of the primitive attributes for ID = " +
            primitiveId
          );
        ...
        if (!(parts_u != null && !isNaN(parts_u)))
          return (
            "unable to parse parts_u of the primitive attributes for ID = " +
            primitiveId
          );
        ...
        if (!(degree_v != null && !isNaN(degree_v)))
          return (
            "unable to parse degree_v of the primitive attributes for ID = " +
            primitiveId
          );
        ...
        if (!(parts_v != null && !isNaN(parts_v)))
          return (
            "unable to parse parts_v of the primitive attributes for ID = " +
            primitiveId
          );
  ...
  parseAnimations(animationsNode) {
    ...
    for (let i = 0; i < children.length; i++) {
      ...
      if (kfAnimationId == null) return "no ID defined for keyframe animation";
      ...
      for (let j = 0; j < keyframes.length; j++) {
        ...
        if (instant == null)
          return (
            "no instant defined for keyframe in keyframe animation " +
            kfAnimationId
          );
        ...
        if ((index = nodeNames.indexOf("translation")) == -1)
          return (
            "no translation defined for keyframe in keyframe animation " +
            kfAnimationId
          );
        // Check if transformation is in the correct position
        else if (index != TRANSLATION_INDEX)
          return (
            "translation must be the first transformation in keyframe " +
            instant +
            " of keyframe animation " +
            kfAnimationId
          );

        var trans_array = this.parseCoordinates3D(
          translation,
          "translation node for keyframe animation " + kfAnimationId
        );
        if (!Array.isArray(trans_array)) return trans_array;

        // -- ROTATION -- //
        if (rotationX.nodeName != "rotation")
          return (
            "Expected <rotation> tag but found <" + rotationX.nodeName + ">"
          );
        else if (rotationY.nodeName != "rotation")
          return (
            "Expected <rotation> tag but found <" + rotationY.nodeName + ">"
          );
        else if (rotationZ.nodeName != "rotation")
          return (
            "Expected <rotation> tag but found <" + rotationZ.nodeName + ">"
          );

        var rotationXaxis = this.reader.getString(rotationX, "axis");
        if (rotationXaxis == null || rotationXaxis != "x")
          return (
            "Error while computing value for rotation at X axis for keyframe animation " +
            kfAnimationId
          );
        ...
        if (!(rotationXangle != null && !isNaN(rotationXangle)))
          return (
            "Error while computing value for angle at X axis for keyframe animation " +
            kfAnimationId
          );
        ...
        if (rotationYaxis == null || rotationYaxis != "y")
          return (
            "Error while computing value for rotation at Y axis for keyframe animation " +
            kfAnimationId
          );
        ...
        if (!(rotationYangle != null && !isNaN(rotationYangle)))
          return (
            "Error while computing value for angle at Y axis for keyframe animation " +
            kfAnimationId
          );
        ...
        if (rotationZaxis == null || rotationZaxis != "z")
          return (
            "Error while computing value for rotation at Z axis for keyframe animation " +
            kfAnimationId
          );
        ...
        if (!(rotationZangle != null && !isNaN(rotationZangle)))
          return (
            "Error while computing value for angle at Z axis for keyframe animation " +
            kfAnimationId
          );
        ...
        if ((index = nodeNames.indexOf("scale")) == -1)
          return (
            "no scale defined for keyframe in keyframe animation " +
            kfAnimationId
          );
        // Check if transformation scale is in the correct position
        else if (index != SCALE_INDEX)
          return (
            "scale must be the last transformation in keyframe " +
            instant +
            " of keyframe animation " +
            kfAnimationId
          );
        ...
        if (!(sx != null && !isNaN(sx)))
          return (
            "Error while computing value for scale value at X axis for keyframe animation " +
            kfAnimationId
          );
        ...
        if (!(sy != null && !isNaN(sy)))
          return (
            "Error while computing value for scale value at Y axis for keyframe animation " +
            kfAnimationId
          );
        ...
        if (!(sz != null && !isNaN(sz)))
          return (
            "Error while computing value for scale value at Z axis for keyframe animation " +
            kfAnimationId
          );
  ...
  parseComponents(componentsNode) {
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      var animationNode =
        animationIndex == -1 ? null : grandChildren[animationIndex];
      var highlightNode =
        highlightIndex == -1 ? null : grandChildren[highlightIndex];

      // ****** TRANSFORMATIONS ******
      if (transfNode.length == 0) transf = mat4.create();
      // This is the case in which the transformation is being mentioned, not created
        ...
        if (this.transformations[transnfID] != null)
          ...
          this.onXMLMinorError(
            "Undefined transformation with the id: " + transnfID
          );
      }

      // parse a new tranformation
      else transf = this.parseNewTransformation(transfNode);
      ...
      for (var j = 0; j < materialNode.length; j++) {
        ...
        if (
          materialID[j] != "inherit" &&
          this.materials[materialID[j]] == null
        ) {
      ...
      if (textureID == "inherit" || textureID == "none") {
        if (length_s != null || length_t != null) {
          this.onXMLMinorError(
            "[COMPONENT:" +
              ...
              "] -> When texture ID is " +
              textureID +
              " length_s and length_t should not be defined"
          );
          if (textureID == "inherit") {
            this.onXMLMinorError(
              "Will use the values defined instead of the ones inherited from the parent component"
            );
        ...
        if (length_s == null || length_t == null) {
          this.onXMLMinorError(
            "[COMPONENT:" +
              componentID +
              "] -> When textureID is neither 'none' nor 'inherit' length_s and length_t should be defined"
          );
      ...
      if (animationNode != null) {
        ...
        if (this.kfAnimations[animationId] == null) {
          this.onXMLMinorError(
            "No animation with the ID of : " +
              animationId +
              "using animationId = null"
          );
          animationId == null;
        }
      }
      ...
      switch (transfNode[j].nodeName) {
        ...
        case "translate":
          var coordinates = this.parseCoordinates3D(
            transfNode[j],
            "translate transformation on component node"
          );
        ...
        case "scale":
          var coordinates = this.parseCoordinates3D(
            transfNode[j],
            "scale transformation on component node"
          );
          if (!Array.isArray(coordinates)) return coordinates;
        ...
        case "rotate":
          ...
          if (axis != "x" && axis != "y" && axis != "z")
            this.onXMLError(
              "Invalid axis for transformation on component node"
            );
  ...
  displayComponent(
    ...
    if (currNode.componentID == "person1" && !this.displayPlayer1)
        return;

    if (currNode.componentID == "person2" && !this.displayPlayer2)
        return;
    ...
    var matID =
      currNode.materialID != "inherit" ? currNode.materialID : prevMaterialID;
    ...
    if (display != 0) {
      ...
      for (var i = 0; i < currNode.primitives.length; i++) {
        ...
        else primitive.updateTexCoords(currNode.lenght_s, currNode.lenght_t);
